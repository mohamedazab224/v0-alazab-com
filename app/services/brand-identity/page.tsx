  ...
  return (
    <div className={`flex min-h-screen flex-col ${language === "ar" ? "rtl" : "ltr"}`}>
      ...
      <section className="relative h-[500px] w-full overflow-hidden">
        ...
        <Image
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/service-6%281%29-lZsEVN4Xav5KmLvqKvH8clNqaKKAFG.png"
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/service-7%281%29-fA9JgndZGltdY8LOqeKAlJqjMYex62.png"
